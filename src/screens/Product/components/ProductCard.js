  ...
  return (
    ...
    >
      ...
      <View style={[styles.imageWrapper, { backgroundColor: item.bgColor || '#F3EBE0' }]}>
        ...
        {/* Tag */}
        {item.tag && (
          <View style={[styles.tag, { backgroundColor: item.tag === 'NEW' ? colors.accent : colors.brandGold }]}>
        ...
        >
          <Text style={{ fontSize: 14, color: wished ? '#E53935' : colors.textMuted }}>
            {wished ? '♥' : '♡'}
          </Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  productTitle: { fontSize: 14, fontWeight: '700', marginBottom: 6, lineHeight: 19 },
